...
export default function ChatScreen({ route, navigation }: Props) {
  ...
  const handleViewProfile = () => {
    ...
    if (context) navigation.navigate('WorkerProfile', { id: context.worker_id });
  };

  const handleJobBannerPress = () => {
    if (isClientViewer) navigation.navigate('CustomerTabs', { screen: 'bookings' });
    else navigation.navigate('WorkerTabs', { screen: 'worker-jobs' });
  };
