...
type Props = NativeStackScreenProps<RootStackParamList, 'BidComparison'>;
...
export default function BidComparisonScreen({ route, navigation }: Props) {
                    ...
                    <>
                      <View style={styles.actionsRow}>
                        ...
                        <TouchableOpacity
                          ...
                          activeOpacity={0.85}
                          onPress={() => navigation.navigate('WorkerProfile', { id: bid.worker_id })}
                        >
