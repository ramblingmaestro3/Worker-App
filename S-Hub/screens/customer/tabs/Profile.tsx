...
/* ─── Reusable menu row — mirrors WorkerProfileSettings.tsx's MenuItem ─── */
function MenuItem({
  icon,
  label,
  subtitle,
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: T.bg }]} edges={['top', 'bottom']}>
      ...
      >
        ...
        <ScreenContent>
          ...
          {/* ── STATS — mirrors WorkerProfileSettings.tsx's bordered statsStrip ── */}
          ...
          <View style={[styles.section, { backgroundColor: T.card, borderColor: T.border }]}>
            <MenuItem T={T}
              ...
              onPress={() => navigation.navigate('PostAJob', {})}
            />
            <View style={[styles.divider, { backgroundColor: T.divider }]} />
            <MenuItem T={T}
            ...
            <MenuItem T={T}
              ...
              onPress={() => navigation.navigate('WorkerGate')}
            />
          </View>
