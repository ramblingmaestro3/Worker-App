...
export default function AIAssistantScreen({ navigation }: NativeStackScreenProps<RootStackParamList, 'AiAssistant'>) {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({ headerShown: true, headerTitle: 'How can we help?' });
  }, [navigation]);
...
const s = StyleSheet.create({
  ...
  headerSub: { fontSize: 12, color: SUBTLE, textAlign: 'center', lineHeight: 18, paddingHorizontal: 30, paddingTop: 12, marginBottom: 14 },
