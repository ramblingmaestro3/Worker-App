...
const SECTIONS = [
  {
    ...
    content: [
      ...
      { heading: '4. Payments', body: 'AdwumaGo does not process or hold payments. Customers and workers arrange and settle payment for jobs directly between themselves, outside the app.' },
      { heading: '5. Disputes', body: 'In the event of a dispute between a customer and worker, including disputes over payment arranged outside the app, AdwumaGo will mediate where possible but bears no financial liability for outcomes.' },
  ...
  },
  {
    ...
    content: [
      ...
      { heading: '2. Use of Data', body: 'Your data is used to match you with service providers and to improve our platform. AdwumaGo does not process or store payment information — payment for jobs is arranged directly between customers and workers, outside the app.' },
      { heading: '3. Data Sharing', body: 'We do not sell your personal data, and we do not share it with payment processors — the app does not use any.' },
...
export default function TermsScreen({ navigation }: NativeStackScreenProps<RootStackParamList, 'Terms'>) {
