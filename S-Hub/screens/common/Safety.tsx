...
export default function SafetyScreen({ navigation }: NativeStackScreenProps<RootStackParamList, 'Safety'>) {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({ headerShown: true, headerTitle: 'Safety' });
  }, [navigation]);
