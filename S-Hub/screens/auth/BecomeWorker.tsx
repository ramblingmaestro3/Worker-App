...
/* ─── Main screen ─── */
export default function WorkerSetupScreen({ navigation }: NativeStackScreenProps<RootStackParamList, 'BecomeWorker'>) {
  ...
  const handleBack = () => {
    ...
    else navigation.navigate('CustomerTabs', { screen: 'home' });
  };
            ...
            <>
              ...
              <View style={[s.termsBox, { backgroundColor: T.card, borderColor: T.border }]}>
                ...
                <Text style={[s.termsText, { color: T.subText }]}>
                  ...
                  <Text style={s.termsLink} onPress={() => navigation.navigate('Terms')}>
