...
export default function VerificationPendingScreen({ navigation }: NativeStackScreenProps<RootStackParamList, 'VerificationPending'>) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      timer = setTimeout(async () => {
        ...
        if (!cancelled) navigation.replace('Verified');
      }, REVIEW_DURATION_MS);
    })();
