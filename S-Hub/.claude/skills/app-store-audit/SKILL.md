...
description: Audit a mobile app against 140+ Apple App Store and Google Play submission rules across 32 categories (privacy, permissions, security, UI/UX, metadata, billing). Works with any framework — Flutter, React Native, Swift/SwiftUI, Kotlin/Compose, KMP, Xamarin, .NET MAUI. Use before a store submission, when asked to check store readiness or compliance, or to diagnose an App Store / Play Store rejection.
---
